...
class Exercise3_Verbose
{
   static void Main()
   {
      ...
      Console.WriteLine("Address: " + customerStreetAddress + ", " + customerCity + ", " + customerState + " " + customerZip);
      Console.WriteLine("Phone: " + customerPhone1 + "-" + customerPhone2 + "-" + customerPhone3);
      Console.WriteLine("");
      Console.WriteLine("Vehicle: " + vehicleYearOfManufacture + " " + vehicleManufacturerCompanyName + " " + vehicleModelNameString);
      ...
      Console.WriteLine("");
      Console.WriteLine("Labor (" + totalLaborHours + " hours @ $" + laborRatePerHour + "/hr): $" + totalLaborCost);
